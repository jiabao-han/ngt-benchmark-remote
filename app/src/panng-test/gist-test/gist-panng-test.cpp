...
int main()
{
    try {
        ...
        std::string index_path = std::string(index_dir) + "panng-test/gist-test/";
        std::string result_file_path = std::string(result_dir) + "panng-test/gist/gist_recall_qps_result.csv";
