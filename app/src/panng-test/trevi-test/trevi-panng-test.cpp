...
const size_t NUM_FOLDS = 2; // Number of folds for cross-validation
...
int main()
{
    try {
        ...
        std::string index_path = std::string(index_dir) + "panng-test/trevi-test/";
        std::string result_file_path = std::string(result_dir) + "panng-test/trevi/trevi_recall_qps_result.csv";
