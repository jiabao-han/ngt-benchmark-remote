...
//        }
        ...
        std::string index_path = std::string(index_dir) + "panng-test/siftsmall-test";
        std::string result_file_path = std::string(result_dir) + "panng-test/siftsmall/siftsmall_recall_qps_result.csv";
