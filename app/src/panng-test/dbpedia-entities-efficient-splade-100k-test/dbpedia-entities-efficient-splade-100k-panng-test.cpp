...
int main()
{
    try {
        ...
        std::string index_data_file = std::string(data_dir) + "dbpedia-entities-efficient-splade-100k/dbpedia-entities-efficient-splade-100k_base.fvecs";
        std::string query_data_file = std::string(data_dir) + "dbpedia-entities-efficient-splade-100k/dbpedia-entities-efficient-splade-100k_query.fvecs";
        std::string ground_truth_file = std::string(data_dir) + "dbpedia-entities-efficient-splade-100k/dbpedia-entities-efficient-splade-100k_groundtruth.ivecs";
        std::string index_path = std::string(index_dir) + "panng-test/dbpedia-entities-efficient-splade-100k-test/";
        std::string result_file_path = std::string(result_dir) + "panng-test/dbpedia-entities-efficient-splade-100k/dbpedia-entities-efficient-splade-100k_recall_qps_result.csv";
        ...
        std::vector<double> query_args = {
            0.6, 0.8, 0.9, 1.0, 1.02, 1.05, 1.1, 1.2, 1.3, 1.4, 2.0
        };
