...
int main()
{
    try {
        ...
        std::string index_path = std::string(index_dir) + "qg-test/siftsmall-test/";
        std::string result_file_path = std::string(result_dir) + "qg-test/siftsmall/siftsmall_recall_qps_result.csv";
