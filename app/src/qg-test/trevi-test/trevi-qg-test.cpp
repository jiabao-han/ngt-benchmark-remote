...
int main()
{
    try {
        ...
        std::string index_path = std::string(index_dir) + "qg-test/trevi-test/";
        std::string result_file_path = std::string(result_dir) + "qg-test/trevi/trevi_recall_qps_result.csv";
