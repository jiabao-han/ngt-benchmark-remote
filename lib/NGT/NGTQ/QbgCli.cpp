...
public:
    QbgCliBuildParameters(NGT::Args& a)
        : args(a)
    {
        args.parse("Zv");
    }
    ...
    void getHierarchicalClustringParameters()
    {
        ...
        case 'l':
        case 'h':
            hierarchicalClustering.initMode = NGT::Clustering::InitializationModeHead;
            break;
        case 'r':
            hierarchicalClustering.initMode = NGT::Clustering::InitializationModeRandom;
            break;
        case 'R':
            hierarchicalClustering.initMode = NGT::Clustering::InitializationModeRandomFixedSeed;
            break;
        case 'P':
    ...
    void getOptimizationParameters()
    {
        ...
        case 'h':
            ...
            break;
        case 'r':
            optimization.initMode = NGT::Clustering::InitializationModeRandom;
            break;
        case 'p':
            optimization.initMode = NGT::Clustering::InitializationModeKmeansPlusPlus;
            break;
        case 'R':
            optimization.initMode = NGT::Clustering::InitializationModeRandomFixedSeed;
            break;
        case 'P':
            optimization.initMode = NGT::Clustering::InitializationModeKmeansPlusPlusFixedSeed;
            break;
        default:
        case '-':
        case 'b':
            optimization.initMode = NGT::Clustering::InitializationModeBest;
            break;
        }
#else
...
public:
    SearchParameters(NGT::Args& args)
        : NGT::Command::SearchParameters(args, "0.02")
    {
...
void QBG::CLI::search(NGT::Args& args)
{
    ...
    try {
        for (size_t trial = 0; trial < nOfTrials; trial++) {
            ...
            if (outputMode == 's') {
                cout << "# Beginning of Evaluation" << endl;
            }
            string line;
            double totalTime = 0;
            int queryCount = 0;
